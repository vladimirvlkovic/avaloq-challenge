...
public class DiceDistributionController {
    ...
    public Map<Integer, Integer> getDiceDistributionResult(@RequestParam @Min(1) Integer diceNumber,
                                                           @RequestParam @Min(4) Integer sideNumber,
                                                           @RequestParam @Min(1) Integer rollNumber) {
    ...
    public Map<Integer, BigDecimal> getRelativeDiceDistribution(@RequestParam @Min(1) Integer diceNumber,
                                                                @RequestParam @Min(4) Integer sideNumber) {
